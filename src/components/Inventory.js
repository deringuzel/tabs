...
class Inventory extends React.Component{
	...
	//to make sure you only log in once
	componentDidMount() {
		Base.onAuth((user) => {
			if(user) {
	...
	handleChange(e, key) {
		...
		//take a copy of the fish and update it w the new data
	...
	renderInventory(key) {
		...
		return(
			<div className="fish-edit" key={key}>
				...
				<textarea type="text" name="dec" value={fish.desc} placeholder="Fish Desc"
